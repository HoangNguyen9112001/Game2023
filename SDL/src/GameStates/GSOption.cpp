...
void GSOption::Init()
{
	...
	menu_opt->Set2DPosition((SCREEN_WIDTH - menu_opt->GetWidth()) / 2, (SCREEN_HEIGHT - menu_opt->GetHeight()) / 2);
	...
	music_on_bt->Set2DPosition((SCREEN_WIDTH - menu_opt->GetWidth()) / 2 + menu_opt->GetWidth() / 3 - music_on_bt->GetWidth()/2,
								(SCREEN_HEIGHT - menu_opt->GetHeight())/2 + menu_opt->GetHeight() / 3);
	...
	sfx_on_bt->Set2DPosition((SCREEN_WIDTH - menu_opt->GetWidth()) / 2 + menu_opt->GetWidth() / 3 - sfx_on_bt->GetWidth() / 2,
		(SCREEN_HEIGHT - menu_opt->GetHeight()) / 2 + menu_opt->GetHeight() * 2 / 3 - sfx_on_bt->GetHeight() * 2 / 3);
	...
	sfx_off_bt->Set2DPosition((SCREEN_WIDTH - menu_opt->GetWidth()) / 2 + menu_opt->GetWidth() * 2 / 3 - sfx_off_bt->GetWidth() / 2,
		(SCREEN_HEIGHT - menu_opt->GetHeight()) / 2 + menu_opt->GetHeight() * 2 / 3 - sfx_off_bt->GetHeight() * 2/3);
